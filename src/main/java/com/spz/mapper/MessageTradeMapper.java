...
public interface MessageTradeMapper {
    @Insert("insert into message_trade(name, message, trade_time_start, trade_time_finish ,create_time, update_time) values (#{name}, #{image}, #{createTime}, #{trade_time} ,#{updateTime})")
